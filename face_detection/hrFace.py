from face_detection.arcsoft import CLibrary, ASVL_COLOR_FORMAT, ASVLOFFSCREEN,c_ubyte_p,FaceInfo
from face_detection.arcsoft.utils import BufferInfo, ImageLoader
from face_detection.arcsoft.AFD_FSDKLibrary import *
from ctypes import *
import traceback
import cv2
import time
...
def detection(imgPath):
    APPID = c_char_p(b'hereshouldbeyourAPPID')
    FD_SDKKEY = c_char_p(b'hereshouldbeyourFD_SDKKEY')
